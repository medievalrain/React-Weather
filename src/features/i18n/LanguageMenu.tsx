...
function LanguageMenu() {
  ...
  return (
    <div ref={menuRef} className="relative">
      <IconButton onClick={() => setIsOpened((v) => !v)} ariaLabelKey={t("change_language")}>
      ...
      {isOpened && (
        <div className="absolute -right-1/2 z-50 flex flex-col rounded-md bg-white shadow-lg dark:bg-gray-800">
